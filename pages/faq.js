...
const FaqPage = () =>
    <>
        ...
        <div className={styles.faqItems}>
            <div>
                <p>Q. What is Hen.radio?</p>
                <p>A. Hen.radio is Hic et Nunc, or HEN, NFT Music Player. It has been created during the first Hicathon in 2021.
            ...
            <div>
                <p>Q. How does the minting work on hen radio?</p>
                <p> A. Sync your wallet using the <strong>sync</strong> button on the top right corner. A <strong>Mint</strong> button will then appear.</p>
            </div>
            <div>
                <p><strong>Q. Is everything here also work on Hic et Nunc?</strong></p>
                <p>A. Yes, everything on hen.radio will also be available on the main Hic et Nunc site</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>A. Currently technical restrictions are making it difficult to differenciate music HTML from other HTML objkt. For video, the is different than the handling of audio, so it is also difficult to implement.</p>
            </div>
            <div>
            ...
            <div>
                <p><strong>Q. How can I contribute? How do we contact Hen.radio?</strong><br />
                    ...
                    <li>You can find the HEN Discord from this <a href="https://hicetnunc.art/about"><u>About page</u></a>, and from there find the hicathon-wg-7-2-hic-radio group.</li>
